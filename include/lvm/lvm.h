...
/* push  */	case 0x3:  lvmstack_push(vm->mem, args[0]); break;
/* pop   */	case 0x4:  lvmstack_pop(vm->mem, args[0]); break;
/* pushf */	case 0x5:  lvmstack_push(vm->mem, &vm->mem->FLAGS); break;
/* popf  */	case 0x6:  lvmstack_pop(vm->mem, args[0]); break;
...
/* cmp   */	case 0x15: vm->mem->FLAGS =
				...
				break;
/* call	 */	case 0x17: lvmstack_push(vm->mem, instr_idx);
/* jmp	 */	case 0x16: *instr_idx = *args[0] - 1; break;
/* ret   */	case 0x18: lvmstack_pop(vm->mem, instr_idx);
				break;
/* je    */	case 0x19:
